/*
 * VirtualFluentListView - A virtual listview delays fetching model objects until they are actually displayed.
 *
 * Author: Phillip Piper
 * Date: 27/09/2008 9:15 AM
 *
 * Change log:
 * 2015-06-14   JPP  - Moved handling of CheckBoxes on virtual lists into base class (FluentListView).
...
namespace Fluent.Lists {
	...
	public class VirtualFluentListView : AdvancedListView {
		...
		public VirtualFluentListView()
			...
			//this.VirtualItemsSelectionRangeChanged += new ListViewVirtualItemsSelectionRangeChangedEventHandler(VirtualFluentListView_VirtualItemsSelectionRangeChanged);
		...
		/// </summary>
		[Browsable(false)]
		public override bool CanShowGroups => IsVistaOrLater && GroupingStrategy != null;
		...
		protected internal bool CheckedObjectsMustStillExistInList {
			get => checkedObjectsMustStillExistInList;
		...
		public virtual RowGetterDelegate RowGetter {
			get => ((VirtualListVersion1DataSource) virtualListDataSource).RowGetter;
