...
// ReSharper restore DoNotCallOverridableMethodsInConstructor
        ...
        static public bool IsVistaOrLater {
            get {
                if (!AdvancedListView.sIsVistaOrLater.HasValue)
                    AdvancedListView.sIsVistaOrLater = Environment.OSVersion.Version.Major >= 6;
                return AdvancedListView.sIsVistaOrLater.Value;
            }
        }
        ...
        static public bool IsWin7OrLater {
            get {
                if (!AdvancedListView.sIsWin7OrLater.HasValue) {
                    // For some reason, Win7 is v6.1, not v7.0
                    Version version = Environment.OSVersion.Version;
                    AdvancedListView.sIsWin7OrLater = version.Major > 6 || (version.Major == 6 && version.Minor > 0);
                }
                return AdvancedListView.sIsWin7OrLater.Value;
            }
        }
        ...
        static public System.Drawing.Drawing2D.SmoothingMode SmoothingMode {
            get { return AdvancedListView.sSmoothingMode; }
            set { AdvancedListView.sSmoothingMode = value; }
        }
        ...
        static public System.Drawing.Text.TextRenderingHint TextRenderingHint {
            get { return AdvancedListView.sTextRendereringHint; }
            set { AdvancedListView.sTextRendereringHint = value; }
        }
        ...
        static public string GroupTitleDefault {
            get { return AdvancedListView.sGroupTitleDefault; }
            set { AdvancedListView.sGroupTitleDefault = value ?? "{null}"; }
...
// ReSharper disable once UnusedVariable
        ...
        public virtual IEnumerable CheckedObjectsEnumerable {
            ...
            set {
                this.CheckedObjects = AdvancedListView.EnumerableToArray(value, true);
            }
        }
        ...
        public void DisableObjects(IEnumerable models)
        {
            if (models == null)
                return;
            ArrayList list = AdvancedListView.EnumerableToArray(models, false);
...
// ReSharper restore FieldCanBeMadeReadOnly.Global
        ...
        public virtual HotItemStyle HotItemStyleOrDefault {
            get { return this.HotItemStyle ?? AdvancedListView.DefaultHotItemStyle; }
        }
        ...
        public bool ShowHeaderInAllViews {
            get { return AdvancedListView.IsVistaOrLater && showHeaderInAllViews; }
            set {
        ...
        public virtual void AddObjects(ICollection modelObjects) {
            ...
            this.InsertObjects(AdvancedListView.EnumerableCount(this.Objects), modelObjects);
...
// ReSharper disable once CoVariantArrayConversion
        ...
        public virtual void InsertObjects(int index, ICollection modelObjects) {
            ...
            try {
                ...
                ArrayList ourObjects = AdvancedListView.EnumerableToArray(this.Objects, false);
...
// ReSharper restore PossibleMultipleEnumeration
        ...
        public virtual byte[] SaveState() {
            FluentListViewState olvState = new FluentListViewState();
...
// ReSharper restore FieldCanBeMadeReadOnly.Global
        ...
        protected virtual bool HandleEndScroll(ref Message m) {
            ...
            if (!AdvancedListView.IsVistaOrLater && AdvancedListView.IsLeftMouseDown && this.GridLines) {
                this.Invalidate();
                this.Update();
            }
        ...
        protected virtual bool HandleLButtonUp(ref Message m) {
            ...
            if (AdvancedListView.IsVistaOrLater && this.HasCollapsibleGroups)
...
//                    break;
        ...
        /// </summary>
        [Category("Labels - FluentListView"), DefaultValue("Sort ascending by '{0}'"), Localizable(true)]
        ...
        /// 
        /// </summary>
        [Category("Labels - FluentListView"), DefaultValue("Sort descending by '{0}'"), Localizable(true)]
        ...
        /// 
        /// </summary>
        [Category("Labels - FluentListView"), DefaultValue("Group by '{0}'"), Localizable(true)]
        ...
        /// 
        /// </summary>
        [Category("Labels - FluentListView"), DefaultValue("Lock grouping on '{0}'"), Localizable(true)]
        ...
        /// 
        /// </summary>
        [Category("Labels - FluentListView"), DefaultValue("Unlock grouping from '{0}'"), Localizable(true)]
        ...
        /// 
        /// </summary>
        [Category("Labels - FluentListView"), DefaultValue("Turn off groups"), Localizable(true)]
        ...
        /// 
        /// </summary>
        [Category("Labels - FluentListView"), DefaultValue("Unsort"), Localizable(true)]
        ...
        /// 
        /// </summary>
        [Category("Labels - FluentListView"), DefaultValue("Columns"), Localizable(true)]
        ...
        /// 
        /// </summary>
        [Category("Labels - FluentListView"), DefaultValue("Select Columns..."), Localizable(true)]
        ...
        public virtual ToolStripDropDown MakeColumnCommandMenu(ToolStripDropDown strip, int columnIndex) {
            ...
            if (column.Sortable && !String.IsNullOrEmpty(label)) {
                strip.Items.Add(label, AdvancedListView.SortAscendingImage, (EventHandler)delegate(object sender, EventArgs args) {
                    this.Sort(column, SortOrder.Ascending);
                });
            }
            label = String.Format(this.MenuLabelSortDescending, column.Text);
            if (column.Sortable && !String.IsNullOrEmpty(label)) {
                strip.Items.Add(label, AdvancedListView.SortDescendingImage, (EventHandler)delegate(object sender, EventArgs args) {
        ...
        public virtual ArrayList GetSelectedObjects() {
            return AdvancedListView.EnumerableToArray(this.SelectedObjects, false);
        }
        ...
        public virtual ArrayList GetCheckedObjects() {
            return AdvancedListView.EnumerableToArray(this.CheckedObjects, false);
        }
        ...
        private void ReplaceModel(OLVListItem olvi, object newModel) {
            ...
            this.TakeOwnershipOfObjects();
            ArrayList array = AdvancedListView.EnumerableToArray(this.Objects, false);
        ...
        protected virtual void FillInValues(OLVListItem lvi, object rowObject) {
            ...
            if (!lvi.Enabled) {
                ...
                ApplyRowStyle(lvi, this.DisabledItemStyle ?? AdvancedListView.DefaultDisabledItemStyle);
            }
...
#pragma warning restore 168
        ...
        protected virtual void TakeOwnershipOfObjects() {
            ...
            this.objects = AdvancedListView.EnumerableToArray(this.objects, true);
        }
        ...
        protected virtual Control GetCellEditor(OLVListItem item, int subItemIndex) {
            ...
            Control editor = AdvancedListView.EditorRegistry.GetEditor(item.RowObject, column, value) ??
