...
namespace Fluent {
	...
	public class EditorRegistry {
		...
		public void Register(Type type, Type controlType) {
			Register(type, delegate(object model, OLVColumn column, object value) { return controlType.InvokeMember("", BindingFlags.CreateInstance, null, null, null) as Control; });
		}
