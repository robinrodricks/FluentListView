...
// ReSharper restore DoNotCallOverridableMethodsInConstructor
        ...
        static public bool IsVistaOrLater {
            get {
                if (!FluentListView.sIsVistaOrLater.HasValue)
                    FluentListView.sIsVistaOrLater = Environment.OSVersion.Version.Major >= 6;
                return FluentListView.sIsVistaOrLater.Value;
            }
        }
        ...
        static public bool IsWin7OrLater {
            get {
                if (!FluentListView.sIsWin7OrLater.HasValue) {
                    // For some reason, Win7 is v6.1, not v7.0
                    Version version = Environment.OSVersion.Version;
                    FluentListView.sIsWin7OrLater = version.Major > 6 || (version.Major == 6 && version.Minor > 0);
                }
                return FluentListView.sIsWin7OrLater.Value;
            }
        }
        ...
        static public System.Drawing.Drawing2D.SmoothingMode SmoothingMode {
            get { return FluentListView.sSmoothingMode; }
            set { FluentListView.sSmoothingMode = value; }
        }
        ...
        static public System.Drawing.Text.TextRenderingHint TextRenderingHint {
            get { return FluentListView.sTextRendereringHint; }
            set { FluentListView.sTextRendereringHint = value; }
        }
        ...
        static public string GroupTitleDefault {
            get { return FluentListView.sGroupTitleDefault; }
            set { FluentListView.sGroupTitleDefault = value ?? "{null}"; }
...
// ReSharper disable once UnusedVariable
        ...
        public virtual IEnumerable CheckedObjectsEnumerable {
            ...
            set {
                this.CheckedObjects = FluentListView.EnumerableToArray(value, true);
            }
        }
        ...
        /// </summary>
        /// <remarks>If this is not set explicitly, <see cref="FluentListView.DefaultDisabledItemStyle"/>  will be used.</remarks>
        [Category("FluentListView"),
        ...
        public void DisableObjects(IEnumerable models)
        {
            if (models == null)
                return;
            ArrayList list = FluentListView.EnumerableToArray(models, false);
...
// ReSharper restore FieldCanBeMadeReadOnly.Global
        ...
        public virtual HotItemStyle HotItemStyleOrDefault {
            get { return this.HotItemStyle ?? FluentListView.DefaultHotItemStyle; }
        }
        ...
        public bool ShowHeaderInAllViews {
            get { return FluentListView.IsVistaOrLater && showHeaderInAllViews; }
            set {
        ...
        public virtual void AddObjects(ICollection modelObjects) {
            ...
            this.InsertObjects(FluentListView.EnumerableCount(this.Objects), modelObjects);
...
// ReSharper disable once CoVariantArrayConversion
        ...
        public virtual void InsertObjects(int index, ICollection modelObjects) {
            ...
            try {
                ...
                ArrayList ourObjects = FluentListView.EnumerableToArray(this.Objects, false);
...
// ReSharper restore FieldCanBeMadeReadOnly.Global
        ...
        protected virtual bool HandleEndScroll(ref Message m) {
            ...
            if (!FluentListView.IsVistaOrLater && FluentListView.IsLeftMouseDown && this.GridLines) {
                this.Invalidate();
                this.Update();
            }
        ...
        protected virtual bool HandleLButtonUp(ref Message m) {
            ...
            if (FluentListView.IsVistaOrLater && this.HasCollapsibleGroups)
...
//                    break;
        ...
        public virtual ToolStripDropDown MakeColumnCommandMenu(ToolStripDropDown strip, int columnIndex) {
            ...
            if (column.Sortable && !String.IsNullOrEmpty(label)) {
                strip.Items.Add(label, FluentListView.SortAscendingImage, (EventHandler)delegate(object sender, EventArgs args) {
                    this.Sort(column, SortOrder.Ascending);
                });
            }
            label = String.Format(this.MenuLabelSortDescending, column.Text);
            if (column.Sortable && !String.IsNullOrEmpty(label)) {
                strip.Items.Add(label, FluentListView.SortDescendingImage, (EventHandler)delegate(object sender, EventArgs args) {
        ...
        public virtual ArrayList GetSelectedObjects() {
            return FluentListView.EnumerableToArray(this.SelectedObjects, false);
        }
        ...
        public virtual ArrayList GetCheckedObjects() {
            return FluentListView.EnumerableToArray(this.CheckedObjects, false);
        }
        ...
        private void ReplaceModel(OLVListItem olvi, object newModel) {
            ...
            this.TakeOwnershipOfObjects();
            ArrayList array = FluentListView.EnumerableToArray(this.Objects, false);
        ...
        private class SuspendSelectionDisposable : IDisposable {
            public SuspendSelectionDisposable(FluentListView objectListView) {
        ...
        protected virtual void FillInValues(OLVListItem lvi, object rowObject) {
            ...
            if (!lvi.Enabled) {
                ...
                ApplyRowStyle(lvi, this.DisabledItemStyle ?? FluentListView.DefaultDisabledItemStyle);
            }
...
#pragma warning restore 168
        ...
        protected virtual void TakeOwnershipOfObjects() {
            ...
            this.objects = FluentListView.EnumerableToArray(this.objects, true);
        }
        ...
        protected virtual Control GetCellEditor(OLVListItem item, int subItemIndex) {
            ...
            Control editor = FluentListView.EditorRegistry.GetEditor(item.RowObject, column, value) ??
