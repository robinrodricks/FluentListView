 ...
 * v2.3
 * 2009-08-28   JPP  - Initial version (Separated from VirtualFluentListView.cs)
 *
 * To do:
 *
...
namespace Fluent
{
    ...
    public class AbstractVirtualListDataSource : IVirtualListDataSource, IFilterableDataSource
    {
        ...
        public AbstractVirtualListDataSource(VirtualFluentListView listView) {
        ...
        /// </summary>
        protected VirtualFluentListView listView;
    ...
    public class VirtualListVersion1DataSource : AbstractVirtualListDataSource
    {
        ...
        /// </summary>
        /// <param name="listView"></param>
        public VirtualListVersion1DataSource(VirtualFluentListView listView)
            : base(listView) {
        }
