/*
 * DataSourceAdapter - A helper class that translates DataSource events for an FluentListView
 *
...
namespace Fluent {
	...
	public class DataSourceAdapter : IDisposable {
		...
		#region FluentListView event handlers
