...
namespace Fluent {
	...
	public class OLVGroup {
		...
		public bool Collapsed {
			get => GetOneState(GroupState.LVGS_COLLAPSED);
		...
		public bool Collapsible {
			get => GetOneState(GroupState.LVGS_COLLAPSIBLE);
		...
		/// </summary>
		public bool Focused {
			get => GetOneState(GroupState.LVGS_FOCUSED);
		...
		public bool Selected {
			get => GetOneState(GroupState.LVGS_SELECTED);
		...
		public bool Subseted {
			get => GetOneState(GroupState.LVGS_SUBSETED);
