/*
 * DesignSupport - Design time support for the various classes within FluentListView
 *
 ...
 * 2011-06-06   JPP  - Vastly improved FluentListViewDesigner, based off information in
...
namespace Fluent.Design {
	...
	public class FluentListViewDesigner : ControlDesigner {
		...
		public override void Initialize(IComponent component) {
			// Debug.WriteLine("FluentListViewDesigner.Initialize");
		...
		public override void InitializeNewComponent(IDictionary defaultValues) {
			// Debug.WriteLine("FluentListViewDesigner.InitializeNewComponent");
		...
		protected override void Dispose(bool disposing) {
			// Debug.WriteLine("FluentListViewDesigner.Dispose");
			if (disposing) {
		...
		protected override void PreFilterProperties(IDictionary properties) {
			// Debug.WriteLine("FluentListViewDesigner.PreFilterProperties");
			...
			var unwantedProperties = new List<string>(new string[] {
		...
		protected override void PreFilterEvents(IDictionary events) {
			// Debug.WriteLine("FluentListViewDesigner.PreFilterEvents");
			base.PreFilterEvents(events);
			designerFilter.PreFilterEvents(events);

			// Remove the events that don't make sense for an FluentListView.
			// See PreFilterProperties() for why we do this dance rather than just remove the event.
			var unwanted = new List<string>(new string[] {
				"AfterLabelEdit",
				"BeforeLabelEdit",
				"DrawColumnHeader",
				"DrawItem",
		...
		protected override void PostFilterAttributes(IDictionary attributes) {
			// Debug.WriteLine("FluentListViewDesigner.PostFilterAttributes");
		...
		protected override void PostFilterEvents(IDictionary events) {
			// Debug.WriteLine("FluentListViewDesigner.PostFilterEvents");
		...
		private class ListViewActionListAdapter : DesignerActionList {
			public ListViewActionListAdapter(FluentListViewDesigner designer, DesignerActionList wrappedList)
			...
			public override DesignerActionItemCollection GetSortedActionItems() {
				var items = wrappedList.GetSortedActionItems();
			...
			private void EditValue(ComponentDesigner componentDesigner, IComponent iComponent, string propertyName) {
				...
				var tEditorServiceContext = Type.GetType("System.Windows.Forms.Design.EditorServiceContext, System.Design");
			...
			public ImageList LargeImageList {
				get => ((ListView) Component).LargeImageList;
				set => SetValue(Component, "LargeImageList", value);
			}

			public ImageList SmallImageList {
				get => ((ListView) Component).SmallImageList;
				set => SetValue(Component, "SmallImageList", value);
			}

			public View View {
				get => ((ListView) Component).View;
				set => SetValue(Component, "View", value);
			}

			private FluentListViewDesigner designer;
	...
	public class OLVColumnCollectionEditor : CollectionEditor {
		...
		public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value) {
			...
			var olv = context.Instance as AdvancedListView;
