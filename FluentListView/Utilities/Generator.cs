...
namespace Fluent {
	...
	public class Generator : IGenerator {
		...
		public static IGenerator Instance {
			get => instance ?? (instance = new Generator());
			set => instance = value;
		}
		...
		public static void GenerateColumns(AdvancedListView olv, IEnumerable enumerable) {
		...
		/// <param name="enumerable">The collection whose first element will be used to generate columns.</param>
		/// <param name="allProperties">Will columns be generated for properties that are not marked with [OLVColumn].</param>
		public static void GenerateColumns(AdvancedListView olv, IEnumerable enumerable, bool allProperties) {
		...
		/// <param name="olv">The FluentListView to modify</param>
		/// <param name="type">The model type whose attributes will be considered.</param>
		public static void GenerateColumns(AdvancedListView olv, Type type) {
		...
		/// <param name="type">The model type whose attributes will be considered.</param>
		/// <param name="allProperties">Will columns be generated for properties that are not marked with [OLVColumn].</param>
		public static void GenerateColumns(AdvancedListView olv, Type type, bool allProperties) {
		...
		public virtual IList<OLVColumn> GenerateColumns(Type type, bool allProperties) {
			...
			var countPositiveDisplayIndex = 0;
		...
		/// <param name="olv"></param>
		/// <param name="type"></param>
		public static void GenerateMethods(FluentListView olv, Type type) {
